      ...
      <main className="flex-1 flex flex-col h-screen overflow-y-auto">
        <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-30 hidden md:block">
          <div className="px-8 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Link href="/">
                <button className="flex items-center gap-2 px-4 py-2 text-slate-600 bg-white hover:bg-slate-50 border border-slate-200 rounded-xl transition shadow-sm text-sm font-bold">
                  <Globe size={14} />
                  View Website
                </button>
              </Link>
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-50 border border-emerald-100 shadow-sm">
                ...
                <span className="text-emerald-700 text-[10px] font-bold uppercase tracking-widest">
                  Sys. Live
                </span>
              </div>
              <button
            ...
            {activeTab === "overview" && (
              ...
              >
                ...
                <div className="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/40 border border-slate-100">
                  <h3 className="text-xl font-bold text-[#041f50] mb-6 tracking-tight">
                    Quick Jump Actions
                  </h3>
                  <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                    {[
                      ...
                      >
                        ...
                        <p className="text-[#041f50] text-sm font-bold">
                          {action.label}
                        </p>
              ...
              >
                ...
                <div className="bg-white rounded-3xl overflow-hidden shadow-xl shadow-slate-200/40 border border-slate-100">
                  <div className="p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-slate-100 bg-slate-50/50">
                    <div>
                      <h3 className="text-xl font-bold text-[#041f50] tracking-tight">
                        Registered Buyers
                      </h3>
                      <p className="text-sm font-medium text-slate-500 mt-1">
                        {filteredBuyers.length} total access grants
                      </p>
                    </div>
                      ...
                      filteredBuyers.map((b, i) => (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <p className="text-[#041f50] font-bold">
                                {b.email}
                              </p>
                    ...
                    {leads.length === 0 ? (
                      <div className="text-center py-20">
                        ...
                        <p className="text-slate-500 font-medium">
                          Your lead pipeline is currently empty.
                        </p>
                      </div>
                    ) : (
                      leads.map((l, i) => (
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2 mt-0.5">
                                ...
                                <span className="text-slate-500 text-xs px-2 py-0.5 bg-slate-100 rounded-full font-medium">
                                  {l.source}
                                </span>
                              </div>
                            </div>
            ...
            {activeTab === "analytics" && (
              ...
              >
                <div className="bg-white rounded-3xl p-12 text-center shadow-xl shadow-slate-200/40 border border-slate-100">
                  ...
                  <h3 className="text-3xl font-extrabold text-[#041f50] mb-2 tracking-tight">
                    Platform Performance
                  </h3>
                  <p className="text-slate-500 text-sm max-w-lg mx-auto font-medium mb-10">
                    Review{" "}
                    <strong className="text-purple-600">
                      {stats.totalUsageEvents}
                    </strong>{" "}
                    tracked activity points across the website and content
                    workspace.
                  </p>

                  <div className="max-w-4xl mx-auto bg-slate-50 rounded-2xl p-8 border border-dashed border-slate-200">
                    <p className="text-slate-500 font-bold mb-4">
                      Traffic & Activity Overview
                    </p>
                    ...
                    <div className="mt-8">
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-6 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-600 hover:bg-slate-50 transition shadow-sm"
                      >
                        <ExternalLink size={14} /> Open Site Analytics
                      </a>
                    </div>
                  </div>
                </div>
