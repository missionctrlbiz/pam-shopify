...
pdfs = [
    ...
    "Psychiatric_Assessment_Mastery_Canva_Scene_by_Scene_Storyboard_Pack(1).pdf",
    "Psychiatric_Assessment_Mastery_Content_SOP_Handbook.pdf",
    "Psychiatric_Assessment_Mastery_Content_SOP_Handbook_1.pdf",
    "Psychiatric_Assessment_Mastery_Content_SOP_Handbook_2.pdf",
]
