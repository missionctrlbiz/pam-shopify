...
const SCENE_FRAMES = {
  COVER: SCENE_DURATIONS.COVER * FPS,
  // 150
  TEACHING: SCENE_DURATIONS.TEACHING * FPS,
  // 135
...
function calculateTotalFrames(props) {
  if (props.scenes && props.scenes.length > 0) {
    return Math.round(
...
;// ./remotion-src/components/AnimatedText.tsx
/* unused harmony import specifier */ var React;
/* unused harmony import specifier */ var AnimatedText_COLORS;
/* unused harmony import specifier */ var AnimatedText_FONTS;
...
const AnimatedText = ({
  ...
  const translateY = (0,esm.interpolate)(progress, [0, 1], [40, 0]);
...
const AnimatedLines = ({
  ...
  fontSize = 36,
  fontWeight = 400,
  color = AnimatedText_COLORS.navy,
  fontFamily = AnimatedText_FONTS.body,
  staggerFrames = 8,
  baseDelayFrames = 0,
  textAlign = "left",
  lineHeight = 1.5,
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 0, maxWidth } }, lines.map((line, i) => /* @__PURE__ */ React.createElement(
    AnimatedText,
    {
      key: i,
      text: line,
...
;// ./remotion-src/components/PAMLogo.tsx
...
const PAMLogo = ({
  ...
  const computedOpacity = opacity !== void 0 ? opacity : variant === "watermark" ? 0.12 : variant === "footer" ? 0.9 : 1;
  const finalOpacity = (0,esm.interpolate)(progress, [0, 1], [0, computedOpacity]);
...
;// ./remotion-src/scenes/CoverScene.tsx
...
const CoverScene = ({
  ...
  const dividerSpring = (0,esm.spring)({
...
;// ./remotion-src/scenes/TeachingScene.tsx
...
const TeachingScene = ({
  ...
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const enterFade = (0,esm.interpolate)(frame, [0, 8], [0, 1], {
...
const CTAScene = ({
  ...
  const enterFade = (0,esm.interpolate)(frame, [0, 10], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const divSpring = (0,esm.spring)({
    frame: Math.max(0, frame - 4),
    fps,
    config: { mass: 1, damping: 14, stiffness: 120 }
  });
...
const ProgressBar = ({
  ...
  const widthPct = (0,esm.interpolate)(clampedFrame, [0, totalFrames - 1], [0, 100], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ react.createElement(
    ...
    widthPct > 0 && /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
          position: "absolute",
...
const FONT_IMPORT_URL = "https://fonts.googleapis.com/css2?family=Montserrat:wght@700;800;900&family=Open+Sans:wght@400;600;700&display=swap";
const PAMVideo = (props) => {
  ...
  )), /* @__PURE__ */ react.createElement(ProgressBar, { totalFrames: durationInFrames, height: 8 }));
};
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "video-renderer:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkvideo_renderer"] = self["webpackChunkvideo_renderer"] || [];
